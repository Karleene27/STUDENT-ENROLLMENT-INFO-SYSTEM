                        ...
                        <tr>
                            ...
                            <td>
                                @if($student->psa_file || $student->good_moral_file || $student->form137_file)
                                    <div class="d-flex gap-1 flex-wrap">
                                        @if($student->psa_file) <a href="{{ Storage::url($student->psa_file) }}" target="_blank" class="btn btn-xs btn-outline-info">PSA</a> @endif
                                        @if($student->good_moral_file) <a href="{{ Storage::url($student->good_moral_file) }}" target="_blank" class="btn btn-xs btn-outline-info">Good Moral</a> @endif
                                        @if($student->form137_file) <a href="{{ Storage::url($student->form137_file) }}" target="_blank" class="btn btn-xs btn-outline-info">Form 137</a> @endif
                                    </div>
                                @else
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    <button type="button" class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#modal-{{ $student->id }}">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="list-group">
                                            ...
                                            @else
                                                <span class="list-group-item disabled">PSA – Not uploaded</span>
                                            @endif
                                            ...
                                            @else
                                                <span class="list-group-item disabled">Good Moral – Not uploaded</span>
                                            @endif
                                            @if($student->form137_file)
                                                <a href="{{ Storage::url($student->form137_file) }}" target="_blank" class="list-group-item list-group-item-action">📄 Form 137</a>
                                            @else
